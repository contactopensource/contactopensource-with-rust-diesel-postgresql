...
impl crate::traits::as_serde_json_value::AsSerdeJsonValue for Org {
    ...
    fn as_serde_json_value(&self) -> serde_json::Value {
        json!({
            ...
            // Lifetime-related
            "start_date": self.start_date.clone().unwrap().to_owned(),
            "stop_date": self.stop_date.clone().unwrap().to_owned(),
        })
    }
